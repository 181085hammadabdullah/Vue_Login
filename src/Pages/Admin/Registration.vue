    ...
    <div class="col-lg-8 offset-lg-4 col-md-6 offset-md-3" style="text-align:center">
      <form novalidate class="md-layout" @submit.prevent="validateUser">
        <md-card class="md-layout-item md-size-50 md-small-size-100">
          <md-card-header>
            <div class="md-title">Admin Registration</div>
          </md-card-header>
          ...
          <md-button class="md-primary float-left">
            <Router-link to="/AdminLogin" id="link">Login Now</Router-link>
          </md-button>
          <md-card-actions>
        ...
        <md-snackbar :md-active.sync="userSaved">Registration Fails</md-snackbar>
      </form>
    </div>
  </div>
</template>
